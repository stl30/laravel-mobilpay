...
Route::post('/mobilpay/card-redirect', 'Stl30\LaravelMobilpay\Http\Controllers\LaravelMobilpayController@validatePaymentDetails')->name('laravel-mobilpay.cardRedirect');
